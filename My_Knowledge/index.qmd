...
Deskripsi: "Knowledge Layers Overview" — diagram berlapis (layered diagram):
System Foundation → Data & AI → Human & Ethics.
Saran format: layered stack atau concentric circles.
Contoh pemakaian:
![](images/knowledge-layers.png){fig-alt="Knowledge layers" fig-cap="Lapisan pengetahuan yang menopang sistem secara menyeluruh."}
-->
...
Deskripsi: "Human-Centered System" — ilustrasi pengguna di pusat,
dikelilingi oleh sistem, data, dan AI.
Saran format: user-centered diagram.
Contoh pemakaian:
![](images/human-centered.png){fig-alt="Human centered design" fig-cap="Pengguna sebagai pusat dari sistem dan teknologi."}
-->
