...
Deskripsi: "Innovation Overview" — ilustrasi sederhana yang menunjukkan mahasiswa di tengah,
dikelilingi oleh Academic Context dan Financial Context, lalu diarahkan ke Decision Support.
Saran format: diagram konseptual dengan ikon mahasiswa sebagai pusat.
Contoh pemakaian:
![](images/innovation-overview.png){fig-alt="Innovation overview" fig-cap="Inovasi sistem yang memusatkan keputusan pada mahasiswa."}
-->
...
Deskripsi: "Comparison Snapshot" — tabel atau diagram kecil:
To-do App | Finance App | This System
Menunjukkan perbedaan fokus dan nilai.
Saran format: tabel ringkas atau diagram checklist.
Contoh pemakaian:
![](images/comparison.png){fig-alt="System comparison" fig-cap="Posisi inovasi dibandingkan sistem yang sudah ada."}
-->
